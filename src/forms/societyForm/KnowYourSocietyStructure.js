...
const KnowYourSocietyStructure = () => {
  ...
  const onSubmit = (e) => {
    ...
    formdata.append(
      "reflexology_path_condition",
      KnowYourSoceity.ReflexologyCondition
    );
    formdata.append(
      "reflexology_path_remark",
      KnowYourSoceity.ReflexologyRemark
    );
    formdata.append(
      "cycling_track_condition",
    ...
    formdata.append(
      "security_guard_only_in_lift_lobby",
